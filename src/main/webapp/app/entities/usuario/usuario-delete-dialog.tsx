...
import { deleteEntity, getEntity } from './usuario.reducer';
...
export const UsuarioDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="digitadoApp.usuario.delete.question">
        <Translate contentKey="digitadoApp.usuario.delete.question" interpolate={{ id: usuarioEntity.id }}>
