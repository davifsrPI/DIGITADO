...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './atividade.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATIVIDADE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ATIVIDADE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ATIVIDADE actions', async () => {
      const arg = { id: 9606 };
    ...
    it('dispatches UPDATE_ATIVIDADE actions', async () => {
      const arg = { id: 9606 };
    ...
    it('dispatches PARTIAL_UPDATE_ATIVIDADE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ATIVIDADE actions', async () => {
      const arg = 42666;
