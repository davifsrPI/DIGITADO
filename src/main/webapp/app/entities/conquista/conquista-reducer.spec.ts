...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './conquista.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONQUISTA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONQUISTA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONQUISTA actions', async () => {
      const arg = { id: 31027 };
    ...
    it('dispatches UPDATE_CONQUISTA actions', async () => {
      const arg = { id: 31027 };
    ...
    it('dispatches PARTIAL_UPDATE_CONQUISTA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONQUISTA actions', async () => {
      const arg = 42666;
