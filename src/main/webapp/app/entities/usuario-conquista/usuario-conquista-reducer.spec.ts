...
import reducer, {
  ...
  reset,
  updateEntity,
} from './usuario-conquista.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USUARIOCONQUISTA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USUARIOCONQUISTA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USUARIOCONQUISTA actions', async () => {
      const arg = { id: 7219 };
    ...
    it('dispatches UPDATE_USUARIOCONQUISTA actions', async () => {
      const arg = { id: 7219 };
    ...
    it('dispatches PARTIAL_UPDATE_USUARIOCONQUISTA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USUARIOCONQUISTA actions', async () => {
      const arg = 42666;
