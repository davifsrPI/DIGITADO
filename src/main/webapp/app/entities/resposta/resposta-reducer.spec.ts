...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './resposta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESPOSTA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESPOSTA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESPOSTA actions', async () => {
      const arg = { id: 6650 };
    ...
    it('dispatches UPDATE_RESPOSTA actions', async () => {
      const arg = { id: 6650 };
    ...
    it('dispatches PARTIAL_UPDATE_RESPOSTA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESPOSTA actions', async () => {
      const arg = 42666;
