...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTAPALAVRAS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LISTAPALAVRAS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LISTAPALAVRAS actions', async () => {
      const arg = { id: 6421 };
    ...
    it('dispatches UPDATE_LISTAPALAVRAS actions', async () => {
      const arg = { id: 6421 };
    ...
    it('dispatches PARTIAL_UPDATE_LISTAPALAVRAS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LISTAPALAVRAS actions', async () => {
      const arg = 42666;
