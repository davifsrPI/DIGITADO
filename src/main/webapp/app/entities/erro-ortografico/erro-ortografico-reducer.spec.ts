...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ERROORTOGRAFICO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ERROORTOGRAFICO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ERROORTOGRAFICO actions', async () => {
      const arg = { id: 31975 };
    ...
    it('dispatches UPDATE_ERROORTOGRAFICO actions', async () => {
      const arg = { id: 31975 };
    ...
    it('dispatches PARTIAL_UPDATE_ERROORTOGRAFICO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ERROORTOGRAFICO actions', async () => {
      const arg = 42666;
