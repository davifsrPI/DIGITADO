...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './palavra.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PALAVRA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PALAVRA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PALAVRA actions', async () => {
      const arg = { id: 97 };
    ...
    it('dispatches UPDATE_PALAVRA actions', async () => {
      const arg = { id: 97 };
    ...
    it('dispatches PARTIAL_UPDATE_PALAVRA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PALAVRA actions', async () => {
      const arg = 42666;
